* [ ] 2.2.1 프로바이더 추가 a\)    프로바이더는 계정을 통하여 해당 프로바이더의 리소스, 미터링 정보를 가져 오거나 서버를 생성 가능하게 한다. b\)    환경설정 -&gt; 프로바이더 -&gt; 왼쪽 상단 + 모양의 버튼 클릭![](/assets/프로바이더추가1.png)![](/assets/프로바이더추가2.png)
